...
def logged_out(request):
    return render(request, 'ds_auth/logged_out.html')
...
def login_options(request):
    ...
    return render(request, 'ds_auth/login.html', context)
...
def agave_oauth(request):
    ...
    redirect_uri = reverse('ds_auth:agave_oauth_callback')
...
def agave_oauth_callback(request):
    ...
    if 'code' in request.GET:
        ...
        redirect_uri = request.build_absolute_uri(
            reverse('ds_auth:agave_oauth_callback'))
        body = {
        ...
        if user:
            ...
            return HttpResponseRedirect(reverse('ds_auth:login'))
    else:
...
def agave_session_error(request):
    return render(request, 'ds_auth/agave_session_error.html')
